...
public class SettingsActivity extends AppCompatPreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    EditTextPreference etBGPath = null;
    ...
    List<String> preInstalledBGPaths = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        preInstalledBGPaths = new ArrayList<String>();
        ...
        preInstalledBGPaths.add(getString(R.string.BG_PATH_DEFAULT));
        ...
        etBGPath = (EditTextPreference) findPreference(getString(R.string.BG_PATH_KEY));
        lpCPUThreadNum =
    ...
    private void reloadPreferenceAndUpdateUI() {
        ...
        if (modelIdx >= 0 && modelIdx < preInstalledModelPaths.size()) {
            if (!enableCustomSettings) {
                ...
                editor.putString(getString(R.string.BG_PATH_DEFAULT), preInstalledBGPaths.get(modelIdx));
        ...
        etBGPath.setEnabled(enableCustomSettings);
        ...
        String bgPath = sharedPreferences.getString(getString(R.string.BG_PATH_KEY),
        ...
        etBGPath.setSummary(bgPath);
        etBGPath.setText(bgPath);
